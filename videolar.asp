...
<head>
    ...
    family=Lato:wght@400;700&family=Montserrat:wght@400;700&display=swap" rel="stylesheet">
    
    <title>Mezunlar Sitesi || Videolar </title>
</head>
<body>
    <header></header>
        <nav>
        ...
        <section>
         <div class="videolar">
                ...
                %>
                    <div class="video-img">
                        <a target="_self" href="video.asp?id=<%=rs("id")%>">
                        <img src="<%=rs("video_path")%>">
                        </a>
                    </div>
                    <%  
                    rs.movenext
