...
<%
    ...
    ssql="Select * from fotograflar where id="& id &";"
...
<head>
    ...
    <title>Mezunlar Sitesi || Fotoğraf </title>
</head>
<body>
    <header></header>
        <nav>
    ...
    <section>
        ...
        <div class="form3">
            <form action="fotoyorumekle.asp?id=<%=id%>" method="POST">
                    <table class="form3-table">
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <input type="submit" value="Yorum Ekle" name="fotoyorumekle">
                                <br>
                                <input type="reset" value="Reset" name="fotoyorumsil">
                            </td>
                            <td></td>
                        </tr>
                </table>
        ...
        <div class="yorumlar">
            <table class="yorum-table">
                <tr>
                    ...
                    ssqli="Select * from fotoYorumlar where foto_id="& id &" order by id desc;"
