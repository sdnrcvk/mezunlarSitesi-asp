...
<% 
    ...
    ssql="Select ad,soyad,gorev,yasadigisehir,telefon,websayfasi,email from kullanicilar order by id desc;"
...
<head>
    ...
    <title>Mezunlar Sitesi || Kim, Nerede, Ne Yapıyor? </title>
</head>
<body>
    <header></header>
        <nav>
            ...
            <div class="liste">
                <table class="liste-table">
                    ...
                    %>
                       ...
                       <td><%=rs("soyad")%></td>
                       <td><%=rs("gorev")%></td>
                       <td><%=rs("yasadigisehir")%></td>
                       <td><a href="<%=rs("websayfasi")%>"><%=rs("websayfasi")%></a></td>
                       <td><%=rs("telefon")%></td>
                       <td><%=rs("email")%></td>
                    <%  
                        Response.write("</tr>")
